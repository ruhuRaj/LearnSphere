...
const testSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['topic', 'full', 'scholarship', 'daily', 'ai-generated', 'pdf-upload'], default: 'topic' },
  ...
  allowAttempts: { type: Boolean, default: true },
  pdfUrl: { type: String },
  pdfLocalPath: { type: String },
