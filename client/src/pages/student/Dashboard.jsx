        ...
        <div style={{ padding: collapsed ? '18px 14px' : '18px 16px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', minHeight: 64 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <button
              ...
              title="Toggle theme"
              style={{ width: 30, height: 30, borderRadius: 8, border: `1px solid ${C.border}`, background: 'transparent', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}
            >
              <span style={{ fontSize: 13 }}>{theme === 'dark' ? '☀️' : '🌙'}</span>
            </button>
            <button onClick={() => setCollapsed(v => !v)}
              style={{ width: 30, height: 30, borderRadius: 8, border: `1px solid ${C.border}`, background: 'transparent', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <Icon d={collapsed ? 'M13 5l7 7-7 7M5 5l7 7-7 7' : 'M11 19l-7-7 7-7m8 14l-7-7 7-7'} size={14} color={C.textMid} />
            </button>
          </div>
        </div>
